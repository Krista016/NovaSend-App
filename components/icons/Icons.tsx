...
export const CampaignsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m3 3 3 9-3 9 19-9Z" /><path d="m6 12 16 0" />
    </svg>
);
...
export const AccountsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <circle cx="12" cy="12" r="10" />
        <circle cx="12" cy="9" r="3" />
        <path d="M12 12c-3 0-6 2-6 4v1h12v-1c0-2-3-4-6-4z" />
    </svg>
);
...
export const PinIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    ...
    >
        <path d="M16,12V4H17A1,1,0,0,0,18,3V3A1,1,0,0,0,17,2H7A1,1,0,0,0,6,3V3A1,1,0,0,0,7,4H8V12L6,14V16H11V22H13V16H18V14L16,12Z" />
    </svg>
);
...
export const RefreshIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M21.5 2v6h-6"/><path d="M2.5 22v-6h6"/><path d="M2 12a10 10 0 0 1 15.5-8L22 12"/><path d="M22 12a10 10 0 0 1-15.5 8L2 12"/>
    </svg>
);
